...
const testimonials = [
  {
    ...
    author: {
      name: 'John Fitzjerald Kennedy',
      role: 'Visonnary &  Mentor',
  ...
  {
    content: `Imagionation is more important then knowledge`,
    author: {
      name: 'Albert Einstein',
      role: 'Mental Barrier Braker',
      avatar: require('@/img/avatars/sara-vieira.jpg').default,
    },
  },
  {
    content:
      'Life starts once you understand you are an actor in the movie of life, and learn to sit down and enjoy the show',
    author: {
      name: 'Sifu Rama',
      role: 'Chi-Kung Master & Mentor',
      avatar: require('@/img/avatars/ryan-singer.jpg').default,
    },
  },
  {
    content: `You ask what's my resume? `,
