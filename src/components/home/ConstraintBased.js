    ...
    <section id="constraint-based">
      <div className="px-4 sm:px-6 md:px-8 mb-10 sm:mb-16 md:mb-20">
        ...
        <BigText className="mb-8">
          <Widont>A 3 minute "tour" to a digital organization</Widont>
        </BigText>
        <Paragraph className="mb-6">
          Use this opportunity <strong>now</strong> to quickly experience "4 key processes" in a
          digital organization and get a better picture on it's operation.
        </Paragraph>
        ...
        header={
          <div className="flex overflow-auto py-0.5 -my-0.5 -mx-4 sm:-mx-6 md:-mx-8 xl:-ml-4 xl:mr-0 pl-0.5">
            <Tabs
              tabs={{
                sizing: 'Marketing',
                color: 'Contact Center',
                typography: 'Customer Success',
                shadows: 'Teamwork',
              }}
              selected={tab}
              onChange={setTab}
