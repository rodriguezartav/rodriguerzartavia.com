    ...
    <section id="build-anything">
      <div className="px-4 sm:px-6 md:px-8 mb-10 sm:mb-16 md:mb-20">
        ...
        <BigText className="mb-8">
          <Widont>Why do I want to go digital?</Widont>
        </BigText>
        <Paragraph className="mb-6">
          The problem is that you already have by using email, mobile phones and software. Most
          organizations are not ready for the next step which is as much technical as it is
          financial
        </Paragraph>
