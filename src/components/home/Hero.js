                ...
                >
                  <motion.div layout={layout} className="mb-4" transition={TRANSITION}>
                    <Words bolder={step >= 3} layout={layout} transition={TRANSITION}>
                      “Anybody can write code and configure software, what's rare is someone that
                      can transform an organization with it. I'll help you become that someone”
                    </Words>
                  </motion.div>
                  <motion.div
