    ...
    <section id="state-variants">
      <div className="px-4 sm:px-6 md:px-8 mb-10 sm:mb-16 md:mb-20">
        ...
        <Caption as="h2" className="text-light-blue-500 mb-3">
          Several disruptive technologies are reaching a level of maturity
        </Caption>
        <BigText className="mb-8">
          <Widont>The next 2 years are critical</Widont>
        </BigText>
        <Paragraph className="mb-6">
          According to <InlineCode>Gartner</InlineCode> 65% of apps will be developed with{' '}
          <InlineCode>no-code</InlineCode> by <InlineCode>non engineers</InlineCode> ,{' '}
          <InlineCode>non consultants</InlineCode>, <InlineCode>non developers</InlineCode>. Your
          apps will be expected to be entirely developed by your team.
        </Paragraph>
